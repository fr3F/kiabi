...
CREATE TABLE `caisses` (
  ...
  `nocaisse` varchar(50) DEFAULT NULL,
  ...
  `usernameBdd` varchar(50) DEFAULT NULL,
  ...
  CONSTRAINT `caisses_ibfk_1` FOREIGN KEY (`idMagasin`) REFERENCES `magasin` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
