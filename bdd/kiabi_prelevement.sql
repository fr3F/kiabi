...
CREATE TABLE `prelevement` (
  `idprelevement` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `prelevement_ibfk_1` FOREIGN KEY (`idencaissement`) REFERENCES `encaissement` (`idencaissement`) ON DELETE SET NULL ON UPDATE CASCADE
...
-- Dump completed on 2025-09-25 15:43:42
