...
CREATE TABLE `loyalty` (
  ...
  `loyaltyCardNumber` varchar(13) DEFAULT NULL,
  `scoredPoints` int DEFAULT NULL,
  `fidelityDiscount` varchar(1) DEFAULT NULL,
  `idticket` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idticket` (`idticket`),
  CONSTRAINT `loyalty_ibfk_1` FOREIGN KEY (`idticket`) REFERENCES `ticket` (`idticket`) ON DELETE SET NULL ON UPDATE CASCADE
