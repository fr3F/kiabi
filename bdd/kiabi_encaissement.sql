...
CREATE TABLE `encaissement` (
  `idencaissement` int NOT NULL AUTO_INCREMENT,
  ...
  `fonddecaisse` double DEFAULT NULL,
  `contenucaisse` double DEFAULT NULL,
  `updatedAt` datetime DEFAULT NULL,
  `send` int DEFAULT NULL,
  `especeRecu` double DEFAULT NULL,
  `dateValidation` datetime DEFAULT NULL,
  `motifEcart` text,
  `ecart` double DEFAULT NULL,
  PRIMARY KEY (`idencaissement`),
  KEY `idcaissier` (`idcaissier`),
  CONSTRAINT `encaissement_ibfk_1` FOREIGN KEY (`idcaissier`) REFERENCES `utilisateurs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
LOCK TABLES `encaissement` WRITE;
/*!40000 ALTER TABLE `encaissement` DISABLE KEYS */;
/*!40000 ALTER TABLE `encaissement` ENABLE KEYS */;
UNLOCK TABLES;
